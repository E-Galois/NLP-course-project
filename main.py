...
from data_process import sentiment_train_loader, sentiment_test_loader
from model import tokenizer, model, optimizer, criterion
...
def main():
    ...
    for i in range(epochs):
        ...
        '''
        valid_loss, valid_acc = evaluate(tokenizer, model, sentiment_valid_loader, device)
        print("valid loss: ", valid_loss, "\t", "valid acc:", valid_acc)
        '''

    result = test(tokenizer, model, sentiment_test_loader, device)
